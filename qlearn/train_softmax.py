...
def train(bisimulation, opts):
    ...
    plt_path = os.path.join(curr_log_dir, opts.env_name + '_softmax_qlearn.png')
    policy_path = os.path.join(curr_log_dir, opts.env_name + '_softmax_qlearn.npy')
    df_path = os.path.join(curr_log_dir, opts.env_name + '_softmax_qlearn.csv')
    heatmap_path = os.path.join(curr_log_dir, opts.env_name + '_explore_softmax.png')
    ...
    for i in seeds:
        ...
        for i in range(opts.num_iters):
            ...
            action = agent.get_action_softmax(state, possible_actions, opts.temp)
